...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http)  throws Exception {
        http.httpBasic()
                ...
                .antMatchers(HttpMethod.POST, "/login").hasRole(ADMIN_ROLE)
                .antMatchers(HttpMethod.POST, "/login").hasRole(USER_ROLE)
                .antMatchers(HttpMethod.GET, "/login/**").hasRole(ADMIN_ROLE)
                .antMatchers(HttpMethod.GET, "/login/**").hasRole(USER_ROLE)
